...
useEffect(()=>{
  ...
  {           optSection?  
        ...
        <div   style={{height:"60px"}}   >  
                                    ...
                                    />
                                    <button  className='btn-primary btn' style={{marginTop:"10px", backgroundColor:"white" , width:"100px" , marginLeft:"80px", height:"40px", color:"blue" }} onClick={handleRegisterOtp} >Verify OTP</button>  
                                                        </div>
                                                        :
                                                <form className='signupForm' action='' onSubmit={userSignup} style={{ padding: "20px" }} >
                                                
                                                        <h2 style={{ color: "rgb(37, 165, 220)", textAlign: "center" }} >REGISTRATION FORM</h2>
...
{/* 
                            ...
                            defaultCountry="" />  */}
                                                        ...
                                                        <div className='signupuserInput'>
                                                                <input type="password" onChange={(e) => onInputChange(e)}   name='confirmPass' placeholder='Re-Enter Password' />
                                                        </div>
        ...
        //===================================Login form======================================
                                                ...
                                                <form className='signupForm' action='' onSubmit={userLogin} style={{ padding: "70px" }} >
                                                        <h2 style={{color: "rgb(37, 165, 220)", textAlign: "center" }} >LOGIN FORM</h2>
                                                        <div className='signupuserInput'>
                                                                <input type="email" onChange={(e) => onInputChangeLogin(e)} placeholder='Enter E-mail' value={login.email} name="email" />
                                                        </div>
                                                        <div className='signupuserInput'>
...
//=================================Forget Email===================================================
                                                ...
                                                <img src={OtpImg} style={{ objectFit:"fill", width:"50vh", height:"50vh" , margin:"auto" }} alt="" />   
                                             
                                                <>                   
                                                        <div className='signupuserInput' style={{alignItems:"center", marginTop:"20px" , padding:"20px"  }}>  
                                                        { OTP ?
                                                                <>
                                                        <input type="email" onChange={handleForgetEmail} placeholder='Enter Registered Email' value={forgetEmail} name="forgetEmail" style={{fontSize:"25px", width:"80%" }} />

                                                        <button  className='btn-primary btn' style={{marginTop:"20px", backgroundColor:"#007bff" ,fontWeight:"600", fontSize:"25px" }} onClick={handleOtp} >Send OTP</button>
                                                        </>
      ...
      {/* ===========================================Opt validate section ==========================================   */}
                                                           <input type="text" style={{
                                                                fontSize:"25px" , width:"80%" 
                                                           
                                                           }} onChange={handleChangeOtp} placeholder='Enter OTP' name="getOtp" value={getOtp
                                                                } />
                                                                <br />

                                                                <button  className='btn-primary btn' style={{marginTop:"20px", backgroundColor:"#007bff" ,fontWeight:"600", fontSize:"25px" }} onClick={handleOtpSubmit} >Submit</button>
