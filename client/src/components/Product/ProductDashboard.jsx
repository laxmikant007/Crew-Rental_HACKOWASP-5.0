...
const  ProfileDashbord =() => {
    ...
    const getProvider=async()=>{
      const res=await getProductProvider(providerid);
      if(res){
        // setProviderid(res[0])
        setProvider(res[0]);
        // console.log("provider is  -- ", provider.address);
      }
      else{
          ...
          <div className="col-md-6">
            ...
            <div className="card-dashbord">
              <div className="card-body-dashbord">
                ...
                <hr className='hr-dashbord' />
                <p className="card-text-dashbord"><strong>Provider Name:</strong> John Doe</p>
                {/* <hr className='hr-dashbord' />
